...
class RulesVC: UIViewController {
    ...
    func configureRulesLabel() {
        ...
        NSLayoutConstraint.activate([
            rulesLabel.topAnchor.constraint(equalTo: titleLabel.safeAreaLayoutGuide.bottomAnchor, constant: 25),
    ...
    func configureExerciseLabel() {
        ...
        exerciseLabel.text = "♠ = Pushups\n\n♣ = Situps\n\n♦ = Burpees \n\n♥ = Jumping Jacks"
        exerciseLabel.font = .systemFont(ofSize: 19, weight: .semibold)
        exerciseLabel.numberOfLines = 0
        
        NSLayoutConstraint.activate([
            exerciseLabel.topAnchor.constraint(equalTo: rulesLabel.safeAreaLayoutGuide.bottomAnchor, constant: 60),
